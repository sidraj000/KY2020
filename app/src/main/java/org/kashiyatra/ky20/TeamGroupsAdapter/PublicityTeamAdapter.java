...
public class PublicityTeamAdapter extends RecyclerView.Adapter<PublicityTeamAdapter.ViewHolder> {
    private String[] mNames, mRoles, mEmails, mFbLinks, mLinkedInLinks, mPhotoUrls;
    private Context context;

    public PublicityTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public PublicityTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new PublicityTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(PublicityTeamAdapter.ViewHolder holder, final int position) {
