...
public class CreativeTeamAdapter extends RecyclerView.Adapter<CreativeTeamAdapter.ViewHolder> {
    private String[] mNames, mRoles, mEmails, mFbLinks, mLinkedInLinks, mPhotoUrls;
    private Context context;

    public CreativeTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public CreativeTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new CreativeTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(CreativeTeamAdapter.ViewHolder holder, final int position) {
