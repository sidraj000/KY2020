...
public class EventsTeamAdapter extends RecyclerView.Adapter<EventsTeamAdapter.ViewHolder> {
    private String[] mNames, mRoles, mEmails, mFbLinks, mLinkedInLinks, mPhotoUrls;
    private Context context;

    public EventsTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public EventsTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new EventsTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(EventsTeamAdapter.ViewHolder holder, final int position) {
