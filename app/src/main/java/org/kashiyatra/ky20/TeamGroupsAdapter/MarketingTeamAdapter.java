package org.kashiyatra.ky20.TeamGroupsAdapter;
...
public class MarketingTeamAdapter extends RecyclerView.Adapter<MarketingTeamAdapter.ViewHolder> {
    private String[] mNames, mRoles, mEmails, mFbLinks, mLinkedInLinks, mPhotoUrls;
    private Context context;

    public MarketingTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public MarketingTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new MarketingTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(MarketingTeamAdapter.ViewHolder holder, final int position) {
