...
public class CoreTeamAdapter extends RecyclerView.Adapter<CoreTeamAdapter.ViewHolder> {
    ...
    public CoreTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public CoreTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new CoreTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(CoreTeamAdapter.ViewHolder holder, final int position) {
