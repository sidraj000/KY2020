...
public class PubRelTeamAdapter extends RecyclerView.Adapter<PubRelTeamAdapter.ViewHolder> {
    private String[] mNames, mRoles, mEmails, mFbLinks, mLinkedInLinks, mPhotoUrls;
    private Context context;

    public PubRelTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public PubRelTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new PubRelTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(PubRelTeamAdapter.ViewHolder holder, final int position) {
