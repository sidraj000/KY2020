...
public class TechTeamAdapter extends RecyclerView.Adapter<TechTeamAdapter.ViewHolder> {
    ...
    public TechTeamAdapter(Context context, String[] names, String[] roles, String[] photoUrls, String[] emails, String[] fbLinks, String[] linkedInLinks) {
        mNames = names;
        mRoles = roles;
    ...
    @Override
    public TechTeamAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v;
        v = LayoutInflater.from(parent.getContext()).inflate(R.layout.person_view, parent, false);
        return new TechTeamAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(TechTeamAdapter.ViewHolder holder, final int position) {
