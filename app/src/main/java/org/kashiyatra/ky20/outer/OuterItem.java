package org.kashiyatra.ky20.outer;
...
import org.kashiyatra.ky20.inner.InnerAdapter;
import org.kashiyatra.ky20.inner.InnerData;
  ...
  //  private final View mMiddleAnswer;
    ...
    public OuterItem(View itemView, RecyclerView.RecycledViewPool pool) {
      ...
      //  mMiddleAnswer= itemView.findViewById(R.id.header_middle_answer);
        ...
        mRecyclerView.setAdapter(new org.kashiyatra.ky20.inner.InnerAdapter());
    ...
    void setContent(@NonNull List<InnerData> innerDataList) {
        ...
        ((org.kashiyatra.ky20.inner.InnerAdapter)mRecyclerView.getAdapter()).addData(tail);
